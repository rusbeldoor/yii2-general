...
{
    public $controllerNamespace = 'rusbeldoor\yii2General\modules\platform\controllers';
    ...
    public function init()
    {
        ...
        AppHelper::forbiddenExceptionIfNotHavePermission('platform');
        ...
        if (isset(Yii::$app->params['rusbeldoor']['yii2General']['platform']['onlyMigrations'])) {
            $this->onlyMigrations = Yii::$app->params['rusbeldoor']['yii2General']['platform']['onlyMigrations'];
        }
    }
}
