...
class YandexDirectApiHelper
{
    ...
    {
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_URL,  Yii::$app->params['rusbeldoor']['yii2General']['yandex']['direct']['api']['url'] . $function);
        ...
        curl_setopt($curl, CURLOPT_HTTPHEADER, [
            'Authorization: Bearer ' .  Yii::$app->params['rusbeldoor']['yii2General']['yandex']['direct']['api']['token'],
            'Client-Login: ' .  Yii::$app->params['rusbeldoor']['yii2General']['yandex']['direct']['api']['login'],
            'Accept-Language: ru',
